...
export const Footer = () => {
  return (
    <footer className="bg-black-dark border-t border-gray-800">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* About Section */}
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-light-white">MRS</h3>
            ...
            <div className="flex items-center space-x-4 pt-2">
              ...
              <div className="flex space-x-4">
                <a
                  ...
                  className="text-light-gray hover:text-red-600 transition-colors"
                >
          ...
          <div className="space-y-4">
            <h3 className="text-xl font-bold text-light-white">
            ...
            <ul className="space-y-2 text-sm text-light-gray">
              <li className="flex items-center">
                <svg
                  ...
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                  className="h-4 w-4 text-red-main mr-2"
                >
                  <path
                    strokeLinecap="round"
            ...
            <button className="mt-2 border border-red-600 text-red-main hover:bg-red-main hover:text-light-white px-4 py-2 rounded">
              Try Recommendations
            </button>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3 mb-3">
              ...
              <div>
                <h4 className="font-medium text-light-white">Team Workspace</h4>
            ...
            <div className="pt-2">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center text-sm text-red-main hover:underline"
              >
                Visit our GitHub
                <svg
                  xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a
              href="/terms"
              className="text-gray-500 hover:text-light-gray text-sm"
            >
              Terms
            </a>
            <a
